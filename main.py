...
# Import data
df_train = pd.read_csv(open("./Dataset/application_train.csv", "r"))
...
# print( cross_val_score(xclas, x_trn, y_trn) )
# Train and validate
print("############ Validation ######################")
...
df_test = pd.read_csv(open("./Dataset/application_test.csv", "r"))
